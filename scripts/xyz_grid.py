...
axis_options = [
    ...
    AxisOptionTxt2Img("Hires upscaler", str, apply_field("hr_upscaler"), choices=lambda: [*shared.latent_upscale_modes, *shared.nn_latent_upscalers, *[x.name for x in shared.sd_upscalers]]),
