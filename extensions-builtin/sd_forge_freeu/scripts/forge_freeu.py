...
class FreeUForForge(scripts.Script):
    ...
    def ui(self, *args, **kwargs):
        ...
        with InputAccordion(False, label=self.title(),
            ...
            with gr.Row():
                freeu_preset = gr.Dropdown(label='', choices=[x[0] for x in FreeUForForge.presets], value='(presets)',
                                           type='index', scale=0, allow_custom_value=True)
