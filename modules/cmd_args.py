...
parser.add_argument("--spandrel-models-path", type=normalized_filepath, help="Path to directory with Spandrel model file(s).", default=os.path.join(models_path, 'Spandrel'))
