...
options_templates.update(options_section(('upscaling', "Upscaling", "postprocessing"), {
    "spandrel_model_tile_size": OptionInfo(192, "Tile size for Spandrel upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "spandrel_model_tile_overlap": OptionInfo(8, "Tile overlap for Spandrel upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
...
options_templates.update(options_section(('training', "Training", "training"), {
    ...
    "save_training_settings_to_txt": OptionInfo(True, "Save textual inversion settings to a text file whenever training starts."),
...
options_templates.update(options_section(('ui_alternatives', "UI alternatives", "ui"), {
    ...
    "hires_fix_show_iterative": OptionInfo(False, "Hires fix: show iterative upscaling controls").needs_reload_ui(),
